...
- [x] F-PSEA-05 - Plan de ronda EA
- [ ] F-PSEA-05A - Hoja de registro del participante
- [x] F-PSEA-06 - Ficha digital de ronda EA
...
## 03_preparacion_item
- [x] F-PSEA-07 - Preparacion y control del item
...
- [x] F-PSEA-08 - Datos reportados por participante
- [x] F-PSEA-09 - Datos de participantes exportados para analisis PT
- [x] F-PSEA-10 - Registro de preprocesamiento de datos
- [x] F-PSEA-12 - Datos oficiales consolidados para evaluacion de aptitud
- [ ] Archivos CSV o exportaciones conservadas para trazabilidad

## 05_homogeneidad_estabilidad
- [x] F-PSEA-11 - Homogeneidad y estabilidad del item
...
- [x] F-PSEA-13 - Informe final de resultados
...
- [x] F-PSEA-14 - Registro caso de queja o no conformidad, si aplica
