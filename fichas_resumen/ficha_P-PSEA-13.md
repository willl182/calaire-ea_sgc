...
Procedimiento tecnico especifico para la evaluacion de aptitud en dioxido de azufre (SO2) dentro del PEA. El documento activo es el `.docx` original suministrado como `0P-PSEA-05 Procedimiento SO2_v2.docx`, copiado y renombrado como `P-PSEA-13 Procedimiento tecnico SO2.docx`. No debe sustituirse por una transcripcion generada ni por una ficha resumen.
...
- **Omitir particularidades de SO2:** El archivo original conserva las condiciones especificas de este gas (fluorescencia UV, interferencias, etc.).
...
El procedimiento tecnico para SO2 queda controlado como DOCX original activo: `0P-PSEA-05 Procedimiento SO2_v2.docx` copiado byte-a-byte y renombrado como `P-PSEA-13 Procedimiento tecnico SO2.docx`.
