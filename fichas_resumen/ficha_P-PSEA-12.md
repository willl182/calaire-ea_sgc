...
Procedimiento tecnico especifico para la evaluacion de aptitud en ozono (O3) dentro del PEA. El documento activo es el `.docx` original suministrado como `0P-PSEA-04 Procedimiento O3_v2.docx`, copiado y renombrado como `P-PSEA-12 Procedimiento tecnico O3.docx`. No debe sustituirse por una transcripcion generada ni por una ficha resumen.
...
- **Omitir particularidades de O3:** El archivo original conserva las condiciones especificas de este gas (inestabilidad, fotolisis, etc.).
...
El procedimiento tecnico para O3 queda controlado como DOCX original activo: `0P-PSEA-04 Procedimiento O3_v2.docx` copiado byte-a-byte y renombrado como `P-PSEA-12 Procedimiento tecnico O3.docx`.
