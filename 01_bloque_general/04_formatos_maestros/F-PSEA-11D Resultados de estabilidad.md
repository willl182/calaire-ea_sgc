...
**Nombre:** Resultados de estabilidad  
**Version:** 1.0  
**Fecha:** 2026-06-18  
**Estado:** Activo
...
Registrar los resultados de la evaluacion de estabilidad del item de ensayo, exportados desde el modulo de analisis de pt_app, como evidencia de que el item cumple con los criterios definidos en P-PSEA-07.

## 2. Alcance

Este formato aplica a los resultados de estabilidad generados por el modulo de analisis de pt_app para cada ronda de ensayo de aptitud en gases contaminantes criterio.

Incluye:

- Resultados del analisis de estabilidad.
- Identificacion del item de ensayo y la ronda.
- Criterio estadistico aplicado.
- Trazabilidad a los datos preprocesados (F-PSEA-11B).

No incluye:

- Datos preprocesados (F-PSEA-11B).
...
| Rol | Responsabilidad |
|---|---|
| Analista PT | Ejecutar el analisis de estabilidad y generar este formato. |
...
| Estadistico_E | Estadistico de estabilidad calculado. |
...
| ID_datos_preprocesados | Referencia a F-PSEA-11B. |
...
- Los resultados deben provenir de los datos preprocesados (F-PSEA-11B).
...
| F-PSEA-11B | Datos preprocesados que alimentan este resultado. |
| F-PSEA-13 | Informe final de resultados. |
...
- No contiene datos preprocesados (eso es F-PSEA-11B).
