...
| `F-PSEA-05` / `F-PSEA-06` / ficha basica y planificacion de ronda | Definen configuracion, analitos, niveles, criterios y condiciones aplicables. | Deben estar aprobados antes de aplicar calculos oficiales. |
...
Las siguientes capturas se conservan en la subcarpeta `capturas` como evidencia funcional del aplicativo.
